...
export default function Perfil(props) {
  ...
  const sendErrorAlertPerfil = () => {
    ...
    if (700 >= size.width && size.width >= 575) {
      <div>
        {Database.filter((item) => {
          if (item.id === idperfil) return item;
        }).map(item =>
          swal({
            content: (
              <div>
                <img src={LogoOnservice} class="imagelogosmall" />
                <p class="swal-title--perfil">Você está a um passo de contratar {item.name}! </p>
                <p>
                  { }
                </p>
      ...
      <div>
        {Database.filter((item) => {
          ...
          swal({
            ...
            className: "swal-modal--smallester",
            button: {
              className: "swal-button--perfil",
              text: "Entrar em contato",
              value: "whatsapp",
        ...
        {Database.filter((item) => {
          ...
          <div>
            ...
            <div class="row row-information-center">
              <div class="column column-perfilinformationsmall">
                <div class="row row-perfilimagesmall">
                  <img src={item.picture} alt="Perfil" />
                </div>
                <div class="row row-main-information-perfil">
                  ...
                  {/*</div>*/}
                  {/*</div>*/}
                  <div class="column column-perfilnameandbuttonsmall">
                    <div class="row row-perfilnameandbuttonsmall">
                      <a>{item.name}</a>
                      <hr class="perfil-hrsmall" />
                      <button type='button'
                        onClick={
                          messageContrate
                ...
                <div class="row row-professionperfilsmall">
                  {item.jobsRight.map(job =>
                    <p>{job}<br /></p>
                  )}
                  <div class="perfil-descriptionsmall">
