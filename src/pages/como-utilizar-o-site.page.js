...
function ComoUtilizaroSite() {
    return (
        <div class="nomarginpage">
            <h2 class="title-howtouse">Como Utilizar o Site</h2>
            <h2 class="subtitle-howtouse">Veja abaixo os tutoriais de como mexer no site</h2>
            <h2> </h2>
            <div class="row row-all-howtouse">
                <div class="column column-each-howtouse">
                    <div class="row row-title-howtouse">
                        <h2 class="titlerow-howtouse">Tutoriais para <span style={{ color: "rgb(237,125,49)" }}>Cliente</span></h2>
                    </div>
